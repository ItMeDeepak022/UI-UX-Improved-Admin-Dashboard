    ...
    <div className="min-h-screen bg-white md:bg-[#F3F4F6] flex items-center justify-center p-0 md:p-6 lg:p-6 select-none">
      ...
      <div className="w-full max-w-[1120px] bg-white rounded-none md:rounded-3xl shadow-none md:shadow-2xl md:border border-gray-100 overflow-hidden grid grid-cols-1 lg:grid-cols-2 min-h-[640px]">
        ...
        <div className="p-8 sm:p-12 md:p-5 flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-2.5 leading-relaxed">
              ...
              <strong className="text-gray-800 font-semibold">Demo App</strong>. Get started for free.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 px-6 rounded-full bg-black hover:bg-gray-800 text-white font-semibold text-sm shadow-md hover:shadow-lg transition-all active:scale-[0.99] cursor-pointer"
            >
              Login
            </button>
          </form>
          ...
          {/* Social Icons (Black Circles matching screenshot) */}
        ...
        <div className="hidden lg:flex p-0">
          <div className="w-full h-full bg-[#F2FBF6] c p-8 flex flex-col justify-between items-center relative overflow-hidden border border-emerald-100/60">
            ...
            {/* Main Center Illustration (Meditating/Calm Character with Green Sweater & Heart) */}
            <div className="relative flex-1 flex items-center justify-center w-full my-auto z-10 pt-4">
              {/* Background Cloud Doodles */}
              ...
              <div className="relative w-64 h-64 flex items-center justify-center">
                <svg viewBox="0 0 240 240" className="w-full h-full">
                  ...
                  {/* Hands in Gyan Mudra (Meditating) */}
            ...
            {/* Bottom Content: Pagination Dots & Heading */}
